            ...
            <table id="example1" class="table table-bordered table-striped m-t-10">
                ...
                foreach ($datapengiriman as $data) {
                  ...
                  <tr>
                    ...
                    <td class="actions">
                    <a href="<?php echo base_url('#')?>"><button type="button" class="btn btn-icon waves-effect waves-light btn-success"> <i class="fas fa-check-square"></i> &nbsp Validasi</button></a>
